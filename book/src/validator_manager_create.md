...
> With `--eth1-withdrawal-address`, the validators created will have a withdrawal credentials of type `0x01`. To create compounding validators with withdrawal credentials of type `0x02`, use the flag `--compouding`.
